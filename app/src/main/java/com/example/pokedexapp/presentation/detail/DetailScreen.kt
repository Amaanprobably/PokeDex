...
import com.example.pokedexapp.presentation.theme.AtkColor
import com.example.pokedexapp.presentation.theme.DefColor
import com.example.pokedexapp.presentation.theme.HPColor
import com.example.pokedexapp.presentation.theme.RobotoCondensed
import com.example.pokedexapp.presentation.theme.SpAtkColor
import com.example.pokedexapp.presentation.theme.SpDefColor
import com.example.pokedexapp.presentation.theme.SpdColor
...
@Composable
fun AttributeIcons(height: Double, weight: Double) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
